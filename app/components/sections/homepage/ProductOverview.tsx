  ...
  return (
    <section className="relative w-full bg-black py-[100px] overflow-hidden">
      ...
      <div className="absolute inset-0">
        <img 
          alt="Yellow Boat of Hope Foundation" 
          className="w-full h-full object-cover" 
          src="/images/product-overview-bg.jpg" 
        />
        <div className="absolute inset-0 bg-[linear-gradient(-108deg,rgba(2,7,25,0)_-9.54%,#020719_78.8%)]" />
      </div>

      <div className="relative max-w-[1440px] mx-auto px-[5%] lg:px-[60px]">
        <div className="flex flex-col gap-[40px] items-start">
          ...
          <div className="flex flex-col gap-[40px] items-start w-full">
            ...
            <ArrowButton href="#">Explore our legacy</ArrowButton>
          </div>
        </div>
      </div>
    </section>
